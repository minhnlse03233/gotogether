...
public class PlacesAutoCompleteAdapter extends RecyclerView.Adapter<PlacesAutoCompleteAdapter.PredictionHolder> implements Filterable {
    ...
    private QuickSearchFragment mContext;
    private int layout;

    public PlacesAutoCompleteAdapter(QuickSearchFragment context, int resource, GoogleApiClient googleApiClient,
    ...
    private ArrayList<PlaceAutocomplete> getAutocomplete(CharSequence constraint) {
        if (mGoogleApiClient.isConnected()) {
            ...
            if (!status.isSuccess()) {
//                Toast.makeText(mContext.getActivity(),mGoogleApiClient.isConnected()+ "", Toast.LENGTH_LONG).show();
                Toast.makeText(mContext.getActivity(), "Error contacting API: " + status.toString(), Toast.LENGTH_SHORT).show();
    ...
    //PredictionHolder predictionHolder ;
...
//        Toast.makeText(mContext.getActivity(), mPredictionHolder +"", Toast.LENGTH_SHORT).show();
